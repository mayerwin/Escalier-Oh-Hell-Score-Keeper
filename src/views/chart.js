...
export function renderChartView() {
  ...
  if (!figure) {
    root.appendChild(el('div', { class: 'spaced' }, emptyState(t('chart.empty'))));
    return root;
  }
  ...
  for (const s of series) {
    ...
    legend.appendChild(
      el(
        ...
        el('span', { class: 'legend__name', text: s.name }),
        el('span', {
          class: 'legend__value',
  ...
  root.appendChild(el('div', { class: 'spaced' }, panel(el('div', { class: 'chartbox' }, figure), legend)));
