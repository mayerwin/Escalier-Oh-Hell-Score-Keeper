...
export function openRoundSheet(index) {
  ...
  openSheet(({ close }) => {
    ...
    dealBlock.appendChild(el('div', { class: 'row__label' }, el('span', { text: t('stairs.detail.dealer') })));
    ...
    dealBlock.appendChild(
      el('div', { class: 'row__label', style: { 'margin-top': '0.875rem' } }, el('span', { text: t('stairs.detail.lead') }))
    );
    dealBlock.appendChild(
      playerPicker({
        players: game.players,
